...
export interface EffectivePermissionContract { resource: PermissionResource; action: PermissionAction; scopeType: PermissionScopeType; scopeId: string; allowed: boolean; source: PermissionDecisionSource; }
