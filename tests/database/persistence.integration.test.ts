...
describe('PostgreSQL persistence constraints', () => {
  ...
  it('enforces organization and department membership composite constraints', async () => {
    ...
    await db.user.createMany({ data: [{ id: 'org-user-a', name: 'A', systemRole: 'EMPLOYEE', createdAt: now, updatedAt: now }, { id: 'org-user-b', name: 'B', systemRole: 'EMPLOYEE', createdAt: now, updatedAt: now }] });
    ...
    await db.organizationMembership.createMany({ data: [{ id: 'om-a', organizationId: 'org-a', userId: 'org-user-a', role: 'MEMBER', status: 'ACTIVE', createdAt: now, updatedAt: now }, { id: 'om-b', organizationId: 'org-b', userId: 'org-user-b', role: 'MEMBER', status: 'ACTIVE', createdAt: now, updatedAt: now }] });
    ...
    await expect(db.departmentMembership.create({ data: { id: 'dm-wrong-department', organizationId: 'org-a', departmentId: 'dept-b', userId: 'org-user-a', role: 'MEMBER', status: 'ACTIVE', createdAt: now, updatedAt: now } })).rejects.toBeDefined();
    await expect(db.departmentMembership.create({ data: { id: 'dm-wrong-membership', organizationId: 'org-a', departmentId: 'dept-a', userId: 'org-user-b', role: 'MEMBER', status: 'ACTIVE', createdAt: now, updatedAt: now } })).rejects.toBeDefined();
  });
